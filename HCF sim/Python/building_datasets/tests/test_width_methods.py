...
plt.legend()
plt.show()
plt.plot(2*sigmas, rms,label="RMS Width")
plt.plot(2*sigmas,thresh,label="Threshold Width")
plt.plot(2*sigmas,norm_int,label="Normalised Integral")
plt.ylabel("Measured Width, a.u.")
plt.xlabel("Super Gaussian Envelope Sigma")
plt.legend()
plt.show()