...
with open('C:\\Users\\iammo\\Documents\\Optimising-Field-Synthesiser\\HCF sim\\Python\\building datasets\\experimental_tests\\simulation_data\\GDD_simulated.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.writer(f)
    # write the header
