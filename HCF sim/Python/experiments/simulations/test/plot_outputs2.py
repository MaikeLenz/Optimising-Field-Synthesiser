...
axs[3,0].set_xlabel("Wavelength (nm)",fontsize=20)
axs[3,1].set_xlabel("Wavelength (nm)",fontsize=20)
axs[1,0].set_ylabel('Normalised Intensity', size=20)
axs[1,1].set_ylabel('Normalised Intensity', size=20)
...
axs[1,1].set_yticks([0.5,1])
axs[2,0].set_yticks([0.5,1])
axs[2,1].set_yticks([0.5,1])
axs[3,0].set_yticks([0.5,1])
axs[3,1].set_yticks([0.5,1])
# Plot simulated data
"""
...
axs[0,0].plot(df.iloc[:,0], df.iloc[:,1]/max(df.iloc[:,1]), '--', color='m', label='Luna')
...
axs[1,0].plot(df.iloc[:,0], df.iloc[:,1]/max(df.iloc[:,1]), '--', color='m')
...
axs[2,0].plot(df.iloc[:,0], df.iloc[:,1]/max(df.iloc[:,1]), '--', color='m')
...
axs[3,0].plot(df.iloc[:,0], df.iloc[:,1]/max(df.iloc[:,1]), '--', color='m')
...
axs[0,1].plot(df.iloc[:,0], df.iloc[:,1]/max(df.iloc[:,1]), '--', color='m')
...
axs[1,1].plot(df.iloc[:,0], df.iloc[:,1]/max(df.iloc[:,1]), '--', color='m')
...
axs[2,1].plot(df.iloc[:,0], df.iloc[:,1]/max(df.iloc[:,1]), '--', color='m')
...
axs[3,1].plot(df.iloc[:,0], df.iloc[:,1]/max(df.iloc[:,1]), '--', color='m')
...
"""
axs[0,0].plot(wavel_nm, I5/max(I5), color='black', label='Experiment')
axs[1,0].plot(wavel_nm, I6/max(I6), color='black')
axs[2,0].plot(wavel_nm, I7/max(I7), color='black')
axs[3,0].plot(wavel_nm, I8/max(I8), color='black')
axs[0,1].plot(wavel_nm, I9/max(I9), color='black')
axs[1,1].plot(wavel_nm, I10/max(I10), color='black')
axs[2,1].plot(wavel_nm, I11/max(I11), color='black')
axs[3,1].plot(wavel_nm, I12/max(I12), color='black')
"""
axs[2,2].plot(wavel_nm, I13)
axs[2,3].plot(wavel_nm, I14)
axs[2,4].plot(wavel_nm, I15, label='Experimental Data')
"""
axs[0,0].legend(loc=(0,1.05), fontsize=20)

ax2_00 = axs[0,0].twinx()
ax2_00.legend(title='-0.20mm', loc='upper right', title_fontsize=20)
ax2_00.get_yaxis().set_visible(False)
ax2_10 = axs[1,0].twinx()
ax2_10.legend(title='-0.15mm', loc='upper right', title_fontsize=20)
ax2_10.get_yaxis().set_visible(False)
ax2_20 = axs[2,0].twinx()
ax2_20.legend(title='-0.10mm', loc='upper right', title_fontsize=20)
ax2_20.get_yaxis().set_visible(False)
ax2_30 = axs[3,0].twinx()
ax2_30.legend(title='-0.05mm', loc='upper right', title_fontsize=20)
ax2_30.get_yaxis().set_visible(False)
ax2_01 = axs[0,1].twinx()
ax2_01.legend(title='0.00mm', loc='upper right', title_fontsize=20)
ax2_01.get_yaxis().set_visible(False)
ax2_11 = axs[1,1].twinx()
ax2_11.legend(title='0.05mm', loc='upper right', title_fontsize=20)
ax2_11.get_yaxis().set_visible(False)
ax2_21 = axs[2,1].twinx()
ax2_21.legend(title='0.10mm', loc='upper right', title_fontsize=20)
ax2_21.get_yaxis().set_visible(False)
ax2_31 = axs[3,1].twinx()
ax2_31.legend(title='0.15mm', loc='upper right', title_fontsize=20)
