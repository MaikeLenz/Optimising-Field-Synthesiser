...
axs[0,0].plot(Ar_sim_powers, Ar_sim_gauss_PowerScan_widths,'^', label='Luna with Gaussian Input',markersize=12,c="black")
axs[1,0].plot(Ar_sim_pressures, Ar_sim_gauss_PressureScan_widths,'^',markersize=12,c="black")
axs[0,1].plot(Ne_sim_powers, Ne_sim_gauss_PowerScan_widths,'^',markersize=12,c="black")
axs[1,1].plot(Ne_sim_pressures, Ne_sim_gauss_PressureScan_widths,'^',markersize=12,c="black")

axs[0,0].plot(Ar_sim_powers, Ar_sim_pulse_PowerScan_widths,'o', label='Luna with Experimental Input',markersize=12,c="m")
axs[1,0].plot(Ar_sim_pressures, Ar_sim_pulse_PressureScan_widths,'o',markersize=12,c="m")
axs[0,1].plot(Ne_sim_powers, Ne_sim_pulse_PowerScan_widths,'o',markersize=12,c="m")
axs[1,1].plot(Ne_sim_pressures, Ne_sim_pulse_PressureScan_widths,'o',markersize=12,c="m")
