...
axs[0,0].plot(Ar_powers, Ar_PowerScan_widths,'s', label='Experimental Data')
axs[0,0].set_xlabel('Power, W')
axs[0,0].set_ylabel('RMS Width, nm')
axs[1,0].plot(Ar_pressures, Ar_PressureScan_widths,'s')
axs[1,0].set_xlabel('Pressure, bar')
axs[1,0].set_ylabel('RMS Width, nm')
axs[0,1].plot(Ne_powers, Ne_PowerScan_widths,'s')
axs[0,1].set_xlabel('Power, W')
axs[0,1].set_ylabel('RMS Width, nm')
axs[1,1].plot(Ne_pressures, Ne_PressureScan_widths,'s')
