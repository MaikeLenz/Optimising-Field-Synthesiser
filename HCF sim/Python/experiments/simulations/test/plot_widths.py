...
axs[0,0].plot(Ar_sim_powers, Ar_sim_gauss_PowerScan_widths,'^', label='Luna with Gaussian Input',markersize=12)
axs[1,0].plot(Ar_sim_pressures, Ar_sim_gauss_PressureScan_widths,'^',markersize=12)
axs[0,1].plot(Ne_sim_powers, Ne_sim_gauss_PowerScan_widths,'^',markersize=12)
axs[1,1].plot(Ne_sim_pressures, Ne_sim_gauss_PressureScan_widths,'^',markersize=12)

axs[0,0].plot(Ar_sim_powers, Ar_sim_pulse_PowerScan_widths,'o', label='Luna with Experimental Input',markersize=12)
axs[1,0].plot(Ar_sim_pressures, Ar_sim_pulse_PressureScan_widths,'o',markersize=12)
axs[0,1].plot(Ne_sim_powers, Ne_sim_pulse_PowerScan_widths,'o',markersize=12)
axs[1,1].plot(Ne_sim_pressures, Ne_sim_pulse_PressureScan_widths,'o',markersize=12)

axs[0,0].plot(Ar_powers, Ar_PowerScan_widths,'s', label='Experimental Data',markersize=12)
axs[0,0].set_xlabel('Power, W')
axs[0,0].set_ylabel('RMS Width, nm')
axs[1,0].plot(Ar_pressures, Ar_PressureScan_widths,'s',markersize=12)
axs[1,0].set_xlabel('Pressure, bar')
axs[1,0].set_ylabel('RMS Width, nm')
axs[0,1].plot(Ne_powers, Ne_PowerScan_widths,'s',markersize=12)
axs[0,1].set_xlabel('Power, W')
axs[0,1].set_ylabel('RMS Width, nm')
axs[1,1].plot(Ne_pressures, Ne_PressureScan_widths,'s',markersize=12)
...
axs[0,1].set_title('Neon Power Scan', fontsize=22,fontweight="bold")
axs[1,1].set_title('Neon Pressure Scan', fontsize=22,fontweight="bold")
