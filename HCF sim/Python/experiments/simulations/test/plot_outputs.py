...
"""
axs_Ar_powers[0,0].legend(loc='upper left', fontsize=16)
axs_Ne_powers[0,0].legend(loc='upper left', fontsize=16)
axs_Ar_pressures[0,0].legend(loc='upper left', fontsize=16)
axs_Ne_pressures[0,0].legend(loc='upper left', fontsize=16)
