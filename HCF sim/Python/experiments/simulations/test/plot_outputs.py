...
axs_Ar_pressures[0,0].set_yticks([])
axs_Ar_pressures[0,1].set_yticks([])
axs_Ar_pressures[1,0].set_yticks([])
axs_Ar_pressures[1,1].set_yticks([])
axs_Ar_pressures[2,0].set_yticks([])
axs_Ar_pressures[2,1].set_yticks([])
axs_Ar_pressures[3,0].set_yticks([])
...
axs_Ne_pressures[0,0].set_yticks([])
axs_Ne_pressures[0,1].set_yticks([])
axs_Ne_pressures[1,0].set_yticks([])
axs_Ne_pressures[1,1].set_yticks([])
axs_Ne_pressures[2,0].set_yticks([])
axs_Ne_pressures[2,1].set_yticks([])
axs_Ne_pressures[3,0].set_yticks([])
axs_Ne_pressures[3,1].set_yticks([])
axs_Ne_pressures[4,0].set_yticks([])
axs_Ne_pressures[4,1].set_yticks([])
axs_Ne_pressures[5,0].set_yticks([])
axs_Ne_pressures[5,1].set_yticks([])
axs_Ne_pressures[6,0].set_yticks([])
axs_Ne_pressures[6,1].set_yticks([])
...
axs_Ne_powers[4,1].plot(df.iloc[:,0], df.iloc[:,1], '--', color='m')
axs_Ne_powers[4,1].fill_between(wavel_nm,max(df.iloc[:,1])*intens0_3/max(intens0_3),color="lightgray")
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\pulse_input\\Ne_PowerScan_0.4")
axs_Ne_powers[3,1].plot(df.iloc[:,0], df.iloc[:,1], '--', color='m')
axs_Ne_powers[3,1].fill_between(wavel_nm,max(df.iloc[:,1])*intens0_4/max(intens0_4),color="lightgray")
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\pulse_input\\Ne_PowerScan_0.5")
axs_Ne_powers[2,1].plot(df.iloc[:,0], df.iloc[:,1], '--', color='m')
axs_Ne_powers[2,1].fill_between(wavel_nm,max(df.iloc[:,1])*intens0_5/max(intens0_5),color="lightgray")
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\pulse_input\\Ne_PowerScan_0.6")
axs_Ne_powers[1,1].plot(df.iloc[:,0], df.iloc[:,1], '--', color='m')
axs_Ne_powers[1,1].fill_between(wavel_nm,max(df.iloc[:,1])*intens0_6/max(intens0_6),color="lightgray")
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\pulse_input\\Ne_PowerScan_0.7")
axs_Ne_powers[0,1].plot(df.iloc[:,0], df.iloc[:,1], '--', color='m')
axs_Ne_powers[0,1].fill_between(wavel_nm,max(df.iloc[:,1])*intens0_7/max(intens0_7),color="lightgray")
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\pulse_input\\Ne_PowerScan_0.8")
axs_Ne_powers[4,0].plot(df.iloc[:,0], df.iloc[:,1], '--', color='m')
axs_Ne_powers[4,0].fill_between(wavel_nm,max(df.iloc[:,1])*intens0_8/max(intens0_8),color="lightgray")
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\pulse_input\\Ne_PowerScan_0.9")
axs_Ne_powers[3,0].plot(df.iloc[:,0], df.iloc[:,1], '--', color='m')
axs_Ne_powers[3,0].fill_between(wavel_nm,max(df.iloc[:,1])*intens0_9/max(intens0_9),color="lightgray")
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\pulse_input\\Ne_PowerScan_1.0")
axs_Ne_powers[2,0].plot(df.iloc[:,0], df.iloc[:,1], '--', color='m')
axs_Ne_powers[2,0].fill_between(wavel_nm,max(df.iloc[:,1])*intens1_0/max(intens1_0),color="lightgray")
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\pulse_input\\Ne_PowerScan_1.1")
axs_Ne_powers[1,0].plot(df.iloc[:,0], df.iloc[:,1], '--', color='m')
axs_Ne_powers[1,0].fill_between(wavel_nm,max(df.iloc[:,1])*intens1_1/max(intens1_1),color="lightgray")
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\pulse_input\\Ne_PowerScan_1.2")
axs_Ne_powers[0,0].plot(df.iloc[:,0], df.iloc[:,1], '--', color='m', label='Luna')
axs_Ne_powers[0,0].fill_between(wavel_nm,max(df.iloc[:,1])*intens1_2/max(intens1_2),color="lightgray")

# Argon pressure scan
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\pulse_input\\Ar_PressureScan_0.2")
axs_Ar_pressures[2,1].plot(df.iloc[:,0], df.iloc[:,1], '--', color='m')
axs_Ar_pressures[2,1].fill_between(wavel_nm,max(df.iloc[:,1])*intens1_1/max(intens1_1),color="lightgray")
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\pulse_input\\Ar_PressureScan_0.4")
axs_Ar_pressures[1,1].plot(df.iloc[:,0], df.iloc[:,1], '--', color='m')
axs_Ar_pressures[1,1].fill_between(wavel_nm,max(df.iloc[:,1])*intens1_1/max(intens1_1),color="lightgray")
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\pulse_input\\Ar_PressureScan_0.6")
axs_Ar_pressures[0,1].plot(df.iloc[:,0], df.iloc[:,1], '--', color='m')
axs_Ar_pressures[0,1].fill_between(wavel_nm,max(df.iloc[:,1])*intens1_1/max(intens1_1),color="lightgray")
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\pulse_input\\Ar_PressureScan_0.8")
axs_Ar_pressures[3,0].plot(df.iloc[:,0], df.iloc[:,1], '--', color='m')
axs_Ar_pressures[3,0].fill_between(wavel_nm,max(df.iloc[:,1])*intens1_1/max(intens1_1),color="lightgray")
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\pulse_input\\Ar_PressureScan_1.0")
axs_Ar_pressures[2,0].plot(df.iloc[:,0], df.iloc[:,1], '--', color='m')
axs_Ar_pressures[2,0].fill_between(wavel_nm,max(df.iloc[:,1])*intens1_1/max(intens1_1),color="lightgray")
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\pulse_input\\Ar_PressureScan_1.2")
axs_Ar_pressures[1,0].plot(df.iloc[:,0], df.iloc[:,1], '--', color='m')
axs_Ar_pressures[1,0].fill_between(wavel_nm,max(df.iloc[:,1])*intens1_1/max(intens1_1),color="lightgray")
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\pulse_input\\Ar_PressureScan_1.4")
axs_Ar_pressures[0,0].plot(df.iloc[:,0], df.iloc[:,1], '--', color='m', label='Luna')
axs_Ar_pressures[0,0].fill_between(wavel_nm,max(df.iloc[:,1])*intens1_1/max(intens1_1),color="lightgray")
...
axs_Ar_pressures[3,0].plot(wavel_nm, I0_8, color='black')
