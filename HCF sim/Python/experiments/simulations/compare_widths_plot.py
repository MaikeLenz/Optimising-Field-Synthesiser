...
axs[0,1].plot(Ar_pressures, Ar_pressure_theor_widths)
...
axs[0,0].plot(Ar_sim_powers, Ar_sim_gauss_PowerScan_widths,'+', label='Simulation with Gaussian Input')
...
axs[0,0].plot(Ar_sim_powers, Ar_sim_pulse_PowerScan_widths,'+', label='Simulation with Experimental Input')
