...
Ar_powers = [1.2, 1.1, 1.0, 0.9, 0.8, 0.7, 0.6, 0.5, 0.4, 0.3]
Ne_powers = [1.2, 1.1, 1.0, 0.9, 0.8, 0.7, 0.6, 0.5, 0.4, 0.3]
...
I0_4=columns[10]
I0_3=columns[11]
I = [I1_2, I1_1, I1_0, I0_9, I0_8, I0_7, I0_6, I0_5, I0_4, I0_3]
...
# Argon power scan
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ar_PowerScan_0.3")
Ar_sim_gauss_PowerScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ar_PowerScan_0.4")
Ar_sim_gauss_PowerScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ar_PowerScan_0.5")
Ar_sim_gauss_PowerScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ar_PowerScan_0.6")
Ar_sim_gauss_PowerScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ar_PowerScan_0.7")
Ar_sim_gauss_PowerScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ar_PowerScan_0.8")
Ar_sim_gauss_PowerScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ar_PowerScan_0.9")
Ar_sim_gauss_PowerScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ar_PowerScan_1.0")
Ar_sim_gauss_PowerScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ar_PowerScan_1.1")
Ar_sim_gauss_PowerScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ar_PowerScan_1.2")
Ar_sim_gauss_PowerScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))

# Neon power scan
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ne_PowerScan_0.3")
Ne_sim_gauss_PowerScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ne_PowerScan_0.4")
Ne_sim_gauss_PowerScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ne_PowerScan_0.5")
Ne_sim_gauss_PowerScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ne_PowerScan_0.6")
Ne_sim_gauss_PowerScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ne_PowerScan_0.7")
Ne_sim_gauss_PowerScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ne_PowerScan_0.8")
Ne_sim_gauss_PowerScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ne_PowerScan_0.9")
Ne_sim_gauss_PowerScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ne_PowerScan_1.0")
Ne_sim_gauss_PowerScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ne_PowerScan_1.1")
Ne_sim_gauss_PowerScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ne_PowerScan_1.2")
Ne_sim_gauss_PowerScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))

# Argon pressure scan
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ar_PressureScan_0.2")
Ar_sim_gauss_PressureScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ar_PressureScan_0.4")
Ar_sim_gauss_PressureScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ar_PressureScan_0.6")
Ar_sim_gauss_PressureScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ar_PressureScan_0.8")
Ar_sim_gauss_PressureScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ar_PressureScan_1.0")
Ar_sim_gauss_PressureScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ar_PressureScan_1.2")
Ar_sim_gauss_PressureScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ar_PressureScan_1.4")
Ar_sim_gauss_PressureScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))

# Neon pressure scan
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ne_PressureScan_1.0")
Ne_sim_gauss_PressureScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ne_PressureScan_1.2")
Ne_sim_gauss_PressureScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ne_PressureScan_1.4")
Ne_sim_gauss_PressureScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ne_PressureScan_1.6")
Ne_sim_gauss_PressureScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ne_PressureScan_1.8")
Ne_sim_gauss_PressureScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ne_PressureScan_2.0")
Ne_sim_gauss_PressureScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ne_PressureScan_2.2")
Ne_sim_gauss_PressureScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ne_PressureScan_2.4")
Ne_sim_gauss_PressureScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ne_PressureScan_2.6")
Ne_sim_gauss_PressureScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ne_PressureScan_2.8")
Ne_sim_gauss_PressureScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ne_PressureScan_3.0")
Ne_sim_gauss_PressureScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ne_PressureScan_3.2")
Ne_sim_gauss_PressureScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ne_PressureScan_3.4")
Ne_sim_gauss_PressureScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
df = pd.read_csv(filepath+"simulations\\data\\pressure_gradient\\gaussian_input_with_1.25_correction\\Ne_PressureScan_3.6")
Ne_sim_gauss_PressureScan_widths.append(rms_width(df.iloc[:,0], df.iloc[:,1]))
...
for i in range(len(energies)):
    ang_freq_width = theoretical_width(radius, flength, pressure, λ0s[i], ang_freq_to_τ_FWHM(domegas[i]), energies[i], 'Ar', 0.56, correction_to_τ=1.25)
    Ar_power_theor_widths.append(ang_freq_to_wavel_width(ang_freq_width/(4*np.sqrt(np.log(2))), λ0s[i])*(10**9))
Ar_power_theor_widths = np.array(Ar_power_theor_widths)
# Neon power scan
Ne_power_theor_widths = []
pressure = 3*0.66
for i in range(len(energies)):
    ang_freq_width = theoretical_width(radius, flength, pressure, λ0s[i], ang_freq_to_τ_FWHM(domegas[i]), energies[i], 'Ne', 0.69, correction_to_τ=1.25)
    Ne_power_theor_widths.append(ang_freq_to_wavel_width(ang_freq_width/(4*np.sqrt(np.log(2))), λ0s[i])*(10**9))
...
for i in range(len(Ar_pressures)):
    ang_freq_width = theoretical_width(radius, flength, Ar_pressures[i]*0.66, λ0, ang_freq_to_τ_FWHM(domega), energy, 'Ar', 0.62, correction_to_τ=1.25)
    Ar_pressure_theor_widths.append(ang_freq_to_wavel_width(ang_freq_width/(4*np.sqrt(np.log(2))), λ0)*(10**9))
...
for i in range(len(Ne_pressures)):
    ang_freq_width = theoretical_width(radius, flength, Ne_pressures[i]*0.66, λ0, ang_freq_to_τ_FWHM(domega), energy, 'Ne', 0.71, correction_to_τ=1.25)
    Ne_pressure_theor_widths.append(ang_freq_to_wavel_width(ang_freq_width/(4*np.sqrt(np.log(2))), λ0)*(10**9))
...
#axs[1,0].plot(powers, Ne_power_theor_widths)
axs[1,0].fill_between(powers, Ne_power_theor_widths - Ne_pow_errs, Ne_power_theor_widths + Ne_pow_errs, alpha=0.2)
#axs[1,1].plot(Ne_pressures, Ne_pressure_theor_widths, label='Theoretical SPM Width')
axs[1,1].fill_between(Ne_pressures, Ne_pressure_theor_widths - Ne_press_errs, Ne_pressure_theor_widths + Ne_press_errs, alpha=0.2, label='Theoretical SPM Width')

axs[0,0].plot(Ar_powers, Ar_PowerScan_widths,'+')
axs[0,0].set_xlabel('Power, W')
axs[0,0].set_ylabel('RMS Width, nm')
axs[0,1].plot(Ar_pressures, Ar_PressureScan_widths,'+')
axs[0,1].set_xlabel('Pressure, bar')
axs[0,1].set_ylabel('RMS Width, nm')
axs[1,0].plot(Ne_powers, Ne_PowerScan_widths,'+')
axs[1,0].set_xlabel('Power, W')
axs[1,0].set_ylabel('RMS Width, nm')
axs[1,1].plot(Ne_pressures, Ne_PressureScan_widths,'+', label='Experimental Data')
...
axs[0,1].set_title('Argon Pressure Scan', fontsize=18)
axs[1,0].set_title('Neon Power Scan', fontsize=18)
