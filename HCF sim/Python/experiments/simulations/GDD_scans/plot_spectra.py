...
df = pd.read_csv(filepath+"simulations\\GDD_scans\\data\\real_range_with_zero_subtracted\\GDD-0.0984_TOD2.15_pos-0.4.csv")
axs[0,0].plot(df.iloc[:,0], df.iloc[:,1]/10, color='tab:orange')
df = pd.read_csv(filepath+"simulations\\GDD_scans\\data\\real_range_with_zero_subtracted\\GDD-0.101_TOD2.2_pos-0.35.csv")
axs[0,1].plot(df.iloc[:,0], df.iloc[:,1]/10, color='tab:orange')
df = pd.read_csv(filepath+"simulations\\GDD_scans\\data\\real_range_with_zero_subtracted\\GDD-0.103_TOD2.25_pos-0.3.csv")
axs[0,2].plot(df.iloc[:,0], df.iloc[:,1]/10, color='tab:orange')
df = pd.read_csv(filepath+"simulations\\GDD_scans\\data\\real_range_with_zero_subtracted\\GDD-0.105_TOD2.3_pos-0.25.csv")
axs[0,3].plot(df.iloc[:,0], df.iloc[:,1]/10, color='tab:orange')
df = pd.read_csv(filepath+"simulations\\GDD_scans\\data\\real_range_with_zero_subtracted\\GDD-0.108_TOD2.35_pos-0.2.csv")
axs[0,4].plot(df.iloc[:,0], df.iloc[:,1]/10, color='tab:orange')
df = pd.read_csv(filepath+"simulations\\GDD_scans\\data\\real_range_with_zero_subtracted\\GDD-0.11_TOD2.4_pos-0.15.csv")
axs[1,0].plot(df.iloc[:,0], df.iloc[:,1]/10, color='tab:orange')
df = pd.read_csv(filepath+"simulations\\GDD_scans\\data\\real_range_with_zero_subtracted\\GDD-0.112_TOD2.45_pos-0.1.csv")
axs[1,1].plot(df.iloc[:,0], df.iloc[:,1]/10, color='tab:orange')
df = pd.read_csv(filepath+"simulations\\GDD_scans\\data\\real_range_with_zero_subtracted\\GDD-0.115_TOD2.5_pos-0.05.csv")
axs[1,2].plot(df.iloc[:,0], df.iloc[:,1]/10, color='tab:orange')
df = pd.read_csv(filepath+"simulations\\GDD_scans\\data\\real_range_with_zero_subtracted\\GDD-0.117_TOD2.55_pos0.csv")
axs[1,3].plot(df.iloc[:,0], df.iloc[:,1]/10, color='tab:orange')
df = pd.read_csv(filepath+"simulations\\GDD_scans\\data\\real_range_with_zero_subtracted\\GDD-0.12_TOD2.6_pos0.05.csv")
axs[1,4].plot(df.iloc[:,0], df.iloc[:,1]/10, color='tab:orange')
df = pd.read_csv(filepath+"simulations\\GDD_scans\\data\\real_range_with_zero_subtracted\\GDD-0.122_TOD2.66_pos0.1.csv")
axs[2,0].plot(df.iloc[:,0], df.iloc[:,1]/10, color='tab:orange')
df = pd.read_csv(filepath+"simulations\\GDD_scans\\data\\real_range_with_zero_subtracted\\GDD-0.124_TOD2.71_pos0.15.csv")
axs[2,1].plot(df.iloc[:,0], df.iloc[:,1]/10, color='tab:orange')
df = pd.read_csv(filepath+"simulations\\GDD_scans\\data\\real_range_with_zero_subtracted\\GDD-0.127_TOD2.76_pos0.2.csv")
axs[2,2].plot(df.iloc[:,0], df.iloc[:,1]/10, color='tab:orange')
df = pd.read_csv(filepath+"simulations\\GDD_scans\\data\\real_range_with_zero_subtracted\\GDD-0.129_TOD2.81_pos0.25.csv")
axs[2,3].plot(df.iloc[:,0], df.iloc[:,1]/10, color='tab:orange')
df = pd.read_csv(filepath+"simulations\\GDD_scans\\data\\real_range_with_zero_subtracted\\GDD-0.131_TOD2.86_pos0.3.csv")
axs[2,4].plot(df.iloc[:,0], df.iloc[:,1]/10, color='tab:orange', label='Simulated')
