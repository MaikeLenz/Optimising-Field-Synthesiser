...
fig.supxlabel('Wavelength (nm)', size=16)
fig.supylabel('Intensity (a.u.)', size=16)
...
"""
axs[0,0].plot(wavel_nm, I5, color='black')
...
axs[3,1].plot(wavel_nm, I12, color='black', label='Experiment')
"""
axs[2,2].plot(wavel_nm, I13)
axs[2,3].plot(wavel_nm, I14)
axs[2,4].plot(wavel_nm, I15, label='Experimental Data')
"""
axs[3,1].legend(loc='center left', bbox_to_anchor=(1, 0.5), fontsize=16)
