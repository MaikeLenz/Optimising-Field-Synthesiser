...
for i in range(len(energies)):
    ...
    with open('C:\\Users\\iammo\\Documents\\Optimising-Field-Synthesiser\\HCF sim\\Python\\experiments\\simulations\\data\\Ar_PowerScan_'+str(powers[i]), 'w', encoding='UTF8', newline='') as f:
        writer = csv.writer(f)
