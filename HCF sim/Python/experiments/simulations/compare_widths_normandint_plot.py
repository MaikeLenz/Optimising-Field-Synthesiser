...
for i in range(len(I)):
    Ar_PowerScan_widths.append(norm_and_int(wavel_nm, I[i]))
...
for i in range(len(I)):
    Ne_PowerScan_widths.append(norm_and_int(wavel_nm, I[i]))
...
for i in range(len(I)):
    Ar_PressureScan_widths.append(norm_and_int(wavel_nm, I[i]))
...
for i in range(len(I)):
    Ne_PressureScan_widths.append(norm_and_int(wavel_nm, I[i]))
...
for i in range(len(I)):
    Ne_GDDScan_widths.append(norm_and_int(wavel_nm, I[i]))
for i in range(len(I2)):
    Ne_GDDScan_fine_widths.append(norm_and_int(wavel_nm, I2[i]))
...
Ar_sim_gauss_PowerScan_widths.append(norm_and_int(df.iloc[:,0], df.iloc[:,1]))
...
Ne_sim_gauss_PowerScan_widths.append(norm_and_int(df.iloc[:,0], df.iloc[:,1]))
...
Ar_sim_gauss_PressureScan_widths.append(norm_and_int(df.iloc[:,0], df.iloc[:,1]))
...
Ne_sim_gauss_PressureScan_widths.append(norm_and_int(df.iloc[:,0], df.iloc[:,1]))
...
Ar_sim_pulse_PowerScan_widths.append(norm_and_int(df.iloc[:,0], df.iloc[:,1]))
...
Ne_sim_pulse_PowerScan_widths.append(norm_and_int(df.iloc[:,0], df.iloc[:,1]))
...
Ar_sim_pulse_PressureScan_widths.append(norm_and_int(df.iloc[:,0], df.iloc[:,1]))
...
Ne_sim_pulse_PressureScan_widths.append(norm_and_int(df.iloc[:,0], df.iloc[:,1]))
