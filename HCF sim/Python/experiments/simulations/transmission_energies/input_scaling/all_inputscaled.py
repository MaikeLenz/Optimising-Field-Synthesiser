...
ax1.plot(energies_in*1000,transmission_sim,label="Luna, Input Energy times %s"%(round(scaling,2)),marker="^",ls="None",   c="tab:red")
...
ax2 = ax1.twiny()
ax2.set_xlabel("Input Intensity (I$\mathrm{_{0}}$), $\mathrm{10^{13} W/cm^2}$",fontsize=16)
...
ax1.plot(np.array(pressures),transmission_sim,label="Luna, Input Energy times %s"%(round(scaling,2)),marker="^",ls="None",   c="tab:red")
...
ax2 = ax1.twiny()
ax2.set_xlabel(r"Input Intensity (I$\mathrm{_{0}}$), $\mathrm{10^{13}W/cm^2}$",fontsize=16)
ax2.set_xlim(0.2,1.3)
ax2.set_xticks(list(energies_in*1000))
plt.xticks(fontsize=14)
ax2.set_xticklabels(I0)
