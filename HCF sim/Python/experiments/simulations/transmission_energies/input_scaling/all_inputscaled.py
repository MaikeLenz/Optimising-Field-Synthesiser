...
ax1.plot(energies_in*1000, transmission_actual,label="Experiment",marker="o",c="deepskyblue",ls="None" ,markersize=15)
...
#a = np.cos(2*np.pi*np.linspace(0, 1, 60.))
ax1.plot(np.array(pressures), transmission_actual,label=r"Experiment, I$\mathrm{_0}$="+I0+"e13W/$\mathrm{cm^2}$",marker="o",c="deepskyblue",ls="None" ,markersize=15 )
...
plt.xticks(fontsize=16)
#a = np.cos(2*np.pi*np.linspace(0, 1, 60.))
ax1.plot(np.array(pressures), transmission_actual,label=r"Experiment, I$\mathrm{_{0}}$="+I0+"e13$\mathrm{W/cm^2}$",marker="o",c="deepskyblue",ls="None" ,markersize=15 )
ax1.plot(np.array(pressures),transmission_sim,label="Luna, Input Energy times %s"%(round(scaling,2)),marker="^",ls="None" ,markersize=15,   c="m")
ax1.errorbar(np.array(pressures), transmission_actual, xerr = 0.1*np.array(pressures),yerr=0.2*transmission_actual, ls="None" ,markersize=15,c="grey")
