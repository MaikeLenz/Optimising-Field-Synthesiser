...
axs[1,1].plot(Ne_sim_pressures, Ne_sim_gauss_PressureScan_widths, label='Simulated with Gaussian Input')
...
axs[1,1].plot(Ne_sim_pressures, Ne_sim_pulse_PressureScan_widths, label='Simulated with Experimental Input')
