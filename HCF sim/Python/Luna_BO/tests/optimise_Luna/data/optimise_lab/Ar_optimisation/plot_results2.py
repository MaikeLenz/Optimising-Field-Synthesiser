...
with open('C:\\Users\\iammo\\Documents\\Optimising-Field-Synthesiser\\HCF sim\\Python\\Luna_BO\\tests\\optimise_Luna\\data\\optimise_lab\\Ar_optimisation\\spectrum_data\\optimum.csv', 'w', encoding='UTF8', newline='') as f:
...
"""
header = ['Angular Frequency', 'Real Electric Field', 'Imaginary Electric Field']
with open('C:\\Users\\iammo\\Documents\\Optimising-Field-Synthesiser\\HCF sim\\Python\\Luna_BO\\tests\\optimise_Luna\\data\\optimise_lab\\Ar_optimisation\\spectrum_data\\SPM.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.writer(f) # peak_power_1000e-9wavelwindow__init_50_niter_100
    writer.writerow(header)
    for i in range(len(ω2)):
        writer.writerow([ω2[i], Eω2[i].real, Eω2[i].imag])
