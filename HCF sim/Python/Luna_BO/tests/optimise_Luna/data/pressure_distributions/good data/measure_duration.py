...
path = "C:\\Users\\iammo\\Documents\\Optimising-Field-Synthesiser\\HCF sim\\Python\\Luna_BO\\tests\\optimise_Luna\\data\\pressure_distributions\\good data\\spectrum_data\\"
file = "pressure_dist.csv"
filepath = path + file
...
plt.figure(1)
plt.plot(t0[j0:j1]*1e15, np.abs(Et0[j0:j1])**2, label="Optimum with Pressure Distribution", color='black')
plt.xlabel('Time (fs)')
plt.ylabel('Intensity (a.u.)')

#######################################################################################################################
file = "pressure_average.csv"
filepath = path + file
...
plt.figure(1)
plt.plot(t0[j0:j1]*1e15, np.abs(Et0[j0:j1])**2, label="Optimum with Average Pressure", color='tab:red')
