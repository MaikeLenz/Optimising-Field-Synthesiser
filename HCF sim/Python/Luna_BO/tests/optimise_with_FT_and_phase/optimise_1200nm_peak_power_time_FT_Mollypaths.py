...
inits=50
iters=0
result,iterations=Luna_BO_debug(params, initial_values_HCF, function=max_peak_power_1200nm_quadratic_phase, init_points=inits, n_iter=iters)
...
with open('C:\\Users\\iammo\\Documents\\Optimising-Field-Synthesiser\\HCF sim\\Python\\Luna_BO\\tests\\optimise_with_FT_and_phase\\data\\1200nm_phasecondition\\1200nm_He__init_50_niter_0.csv', 'w', encoding='UTF8', newline='') as f:
