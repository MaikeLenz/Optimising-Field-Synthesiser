...
"""
df_iter = pd.read_csv("C:\\Users\\iammo\\Documents\\Optimising-Field-Synthesiser\\HCF sim\\Python\\Luna_BO\\Optimise_Lab\\max_freq_bandwidth_test_pressure_gradient\\Optimal_Params_points_probed.csv")
...
df_optimum = pd.read_csv("C:\\Users\\iammo\\Documents\\Optimising-Field-Synthesiser\\HCF sim\\Python\\Luna_BO\\Optimise_Lab\\max_freq_bandwidth_test_pressure_gradient\\Optimal_Params_optimums.csv")
...
df_iter = pd.read_csv("C:\\Users\\iammo\\Documents\\Optimising-Field-Synthesiser\\HCF sim\\Python\\Luna_BO\\Optimise_Lab\\max_freq_bandwidth_test_pressure_gradient\\Optimal_Params_optimums.csv")
energy = df_iter.iloc[:,2] # J
pressure = df_iter.iloc[:,3] # bar
