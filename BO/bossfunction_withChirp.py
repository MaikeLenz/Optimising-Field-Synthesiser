...
def BO(params, Synth, function, init_points=50, n_iter=50, goal_field=None, t=np.linspace(-20,100,20000), window=None, GDD=None):     
    """
    ...
    def target_func(**args):
        ...
        for i in t: 
            ...
            #if GDD is given, extract channel params and call GDD function here
            #or is it better to integrate this with th ewavepacket class?
